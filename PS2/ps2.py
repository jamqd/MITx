...
class RectangularRoom(object):
    ...
    def cleanTileAtPosition(self, pos):
        ...
        pos: a Position
        """
        self.map[math.floor(pos.getX())][math.floor(pos.getY())] = True
...
class Robot(object):
    ...
    def __init__(self, room, speed):
        ...
        room.cleanTileAtPosition(self.rPosition)
...
class StandardRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        been cleaned.
        """
        newPos = self.rPosition.getNewPosition(self.direction, self.speed)
        while not self.room.isPositionInRoom(newPos):
            self.direction = random.randint(0,359)
            newPos = self.rPosition.getNewPosition(self.direction, self.speed)
        self.rPosition = newPos
        self.room.cleanTileAtPosition(self.rPosition)
