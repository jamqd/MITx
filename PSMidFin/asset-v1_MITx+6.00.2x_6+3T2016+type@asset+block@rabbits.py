...
coeff = pylab.polyfit(range(len(rab)), rab, 2)
pylab.plot(pylab.polyval(coeff, range(len(rab))), label = 'rabbits')
coeff = pylab.polyfit(range(len(fox)), fox, 2)
pylab.plot(pylab.polyval(coeff, range(len(fox))), label = 'foxes')
